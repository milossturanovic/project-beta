...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'project-beta'); ?></a>
			...
			<div class="sticky-area">
				<div class="main-header nav navbar bg-body navbar-light navbar-expand-xl py-6 py-xl-0">
					<div class="container-xxl container flex-nowrap">
						...
						<a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand px-8 py-4 mx-auto">
							<?php if (has_custom_logo()) : ?>
								<?php
								$custom_logo_id = get_theme_mod('custom_logo');
								$logo = wp_get_attachment_image_src($custom_logo_id, 'full');
								?>
								<img class="light-mode-img" src="<?php echo esc_url($logo[0]); ?>" width="179" height="26" alt="<?php bloginfo('name'); ?>">
								<img class="dark-mode-img" src="<?php echo esc_url($logo[0]); ?>" width="179" height="26" alt="<?php bloginfo('name'); ?>">
							<?php else : ?>
						...
						<tbody>
							<tr class="position-relative">
								...
								<td class="shop-product">
									<div class="d-flex align-items-center">
										<div class="me-6">
											<img src="./assets/images/products/product-03-75x100.jpg" width="60" height="80"
							...
							<tr class="position-relative">
								...
								<td class="shop-product">
									<div class="d-flex align-items-center">
										<div class="me-6">
											<img src="./assets/images/products/product-06-75x100.jpg" width="60" height="80"
												alt="natural coconut cleansing oil">
										</div>
										<div class="">
											<p class="card-text mb-1">
							...
							<tr class="position-relative">
								...
								<td class="shop-product">
									<div class="d-flex align-items-center">
										<div class="me-6">
											<img src="./assets/images/products/product-09-75x100.jpg" width="60" height="80"
												alt="natural coconut cleansing oil">
										</div>
										<div class="">
											<p class="card-text mb-1">
